/***************************************************************************
    ...
    version     : $Id: mainnfsperf.cpp,v 1.2.2.1 2008/12/31 03:53:57 berniw Exp $                                  
...
void usage(void)
{
    fprintf(stderr, "Car Specifications Converter $Revision: 1.2.2.1 $ \n");
...
void init_args(int argc, char **argv)
{
	...
	case 0:
		...
		break;
	    case 1:
		printf("Car Specifications Converter $Revision: 1.2.2.1 $ \n");
		exit(0);
		break;
	    default:
		usage();
