...
{
    AEROMAGIC = GfParmGetNum(car->_carHandle, HUMAN_SECT_PRIV, HUMAN_ATT_AMAGIC, (char*)NULL, 1.6f);
	CFRICTION = GfParmGetNum(car->_carHandle, HUMAN_SECT_PRIV, HUMAN_ATT_FMAGIC, (char*)NULL, 1.0f);
